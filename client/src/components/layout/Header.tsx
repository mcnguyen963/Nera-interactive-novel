...
export function Header() {
  ...
  return (
    <header className="flex items-center justify-between px-6 py-2.5 border-b border-[var(--rule)] bg-[var(--page)] sticky top-0 z-50">
      ...
      <div className="flex items-center gap-2">
        ...
        {story && (
          <>
            ...
            <Button onClick={handleDelete} className="text-red-600 border-red-200 hover:border-red-400">
              Delete
            </Button>
          </>
        )}
